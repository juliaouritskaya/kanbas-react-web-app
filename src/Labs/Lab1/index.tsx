        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Cook tagliatelle according to package.</li>
                    <li>While the pasta is cooking, melt the butter in a skillet on low-medium heat.
                        Add in the garlic and whisk.
                    </li>
                    <li>Add in the white wine and turn the heat up a tad so that it’s bubbling. Let
                        the alcohol cook out of the sauce for 2-3 minutes.
                    </li>
                    <li>Add in the heavy cream, 1/2 cup at a time with whisks between each pour. Add
                        the lemon juice here too. It should start to thicken up as it bubbles. If it
                        doesn’t, melting some freshly grated parmesan can help.
                    </li>
                    <li>Season with the garlic powder, salt and pepper here.</li>
                    <li>Continue to whisk on and off for 8-10 minutes while it simmers and turns
                        into what will look like alfredo sauce.
                    </li>
                    <li>Add the cooked pasta straight from it’s boiling water into the lemon butter
                        sauce and gently toss everything together. Add 2-3 tbsp of the hot pasta
                        water.
                    </li>
                    <li>Top with fresh parmesan cheese and more black pepper.</li>
                </ol>
